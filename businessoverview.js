class BusinessOverview {
     ...
     * Only works when #historical-results contains a report (eod-report-content).
     */
    exportEODReportToPdf() {
        ...
        if (!container || !container.querySelector('.eod-report-content')) {
            console.warn('No EOD report content to export');
            return;
        }
        ...
        wrapper.className = 'eod-pdf-content';
        ...
        footer.textContent = `Generated by LIGI Reporting on ${new Date().toLocaleString('en-US')}`;
